...
public class JdbcQueries {
     ...
     *
     * @param args the list of method parameters. args[0] is the SQL. (方法参数列表)
     */
    @OnMethod(
     ...
     * 缓存“预编译SQL”。
     *
     * @param preparedStatement the return value from the prepareXxx() method. (prepareXxx()方法的返回SQL语句)
     */
    @OnMethod(
            clazz = "+java.sql.Connection",
            method = "/prepare(Call|Statement)/",
