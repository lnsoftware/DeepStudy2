...
//        File libDirectory = new File( "src/system_lib");
        File libDirectory = new File( "/Users/hg/Github/DeepStudy2/compiler/TaolanTutorial-master/src/main/resources/system_lib");
