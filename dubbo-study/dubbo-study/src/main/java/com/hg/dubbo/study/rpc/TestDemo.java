 ...
 */
package com.hg.dubbo.study.rpc;
...
//		mutliThreadTest(10,9010);
	...
	private static void startServer(int port) throws Exception {
	    ...
	    dispatcher.addReplier(Object.class, new Replier<Object>() {
			...
			{
				System.out.println("server default reply , handle:"+msg+";thread:"+Thread.currentThread().getName());
	...
	private static void test(int port) throws Exception {
		...
		ResponseFuture re = client.request(new RpcMessage(DemoService.class.getName(), "sayHello", new Class<?>[]{String.class}, new Object[]{"qianlei" }));
		System.out.println(re.get());

		System.out.println("=====test invoke=====");
			ResponseFuture future = client.request(new TestDemo.Data());
