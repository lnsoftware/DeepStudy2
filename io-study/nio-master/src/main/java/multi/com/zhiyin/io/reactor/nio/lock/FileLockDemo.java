package multi.com.zhiyin.io.reactor.nio.lock;
...
public class FileLockDemo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        RandomAccessFile raf = new RandomAccessFile("E:\\2017\\demo\\java\\multi.com.zhiyin.io.reactor.nio\\src\\multi.com.zhiyin.io.reactor.nio\\lock\\temp.txt", (writer) ? "rw" : "r");
    ...
    static void update(FileChannel fc) throws IOException {
        for (int i = 0; i < MAXUPDATES; i++) {
            System.out.println("acquring exclusive lock");
