...
public final class ClassLoaderLeakExample {
  ...
  static final class ChildOnlyClassLoader extends ClassLoader {
    ...
    @Override protected Class<?> loadClass(String name, boolean resolve)
      ...
      try {
        Path path = Paths.get("/Users/hg/Github/DeepStudy2/jdk-learn/classloader/target/classes/com/zhiyin/classloader/ClassLoaderLeakExample$LoadedInChildClassLoader.class");
//        System.out.println();
