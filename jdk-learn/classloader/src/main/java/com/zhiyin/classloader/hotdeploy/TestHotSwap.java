...
public class TestHotSwap {
    public static void main(String[] args) throws Exception {
        ...
        Thread t = new Thread(new ClassChangeMonitor());
        t.start();
    }
}

class ClassChangeMonitor implements Runnable {
    // Hot就是用于修改，用来测试热加载
    private String className = "com.zhiyin.classloader.hotdeploy.HelloRequestProcessor";
