...
public class ElasticsearchReporter extends ScheduledReporter {
    ...
    public void report(SortedMap<String, Gauge> gauges,
        ...
        try {
            ...
            final AtomicInteger entriesWritten = new AtomicInteger(0);
            ...
            for (Map.Entry<String, Gauge> entry : gauges.entrySet()) {
                if (entry.getValue().getValue() != null) {
                    ...
                    JsonMetric jsonMetric = null;
                    if(newVal != null){
                        jsonMetric = new JsonGauge(name(prefix, entry.getKey()), timestamp, newVal);
                    }else{
                        jsonMetric = new JsonGauge(name(prefix, entry.getKey()), timestamp, entry.getValue());
    ...
    private void checkForIndexTemplate() {
        try {
            ...
            if (isTemplateMissing) {
                ...
                json.writeObjectField("index", "analyzed");
