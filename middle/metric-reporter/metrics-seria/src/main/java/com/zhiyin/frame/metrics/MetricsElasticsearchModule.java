...
import static com.zhiyin.frame.metrics.JsonMetrics.*;
...
public class MetricsElasticsearchModule extends Module {
    ...
    private static class GaugeSerializer extends StdSerializer<JsonGauge> {
        ...
        public void serialize(JsonGauge gauge,
            ...
            json.writeStringField("groupKey",gauge.groupKey);
            json.writeStringField("commandKey",gauge.commandKey);
            json.writeStringField("metricType",gauge.metricType);
            json.writeStringField("threadPool",gauge.threadPool);
            json.writeStringField("indexType",gauge.type());
            final Object value;
            try {
