...
public class SleuthDemoApplication {
    ...
    @RequestMapping("/remoteHome/{serverPort}")
    public String callHome(@PathVariable("serverPort") int serverPort) throws URISyntaxException {
        ResponseEntity<String> forEntity = restTemplate.getForEntity(new URI("http://localhost:"+serverPort+"/getTime"), String.class);
